...
4. **Optimize and record the production artifact independently.** The current lossy VP8 WebP is 1600 x 640 and 67,950 bytes. These values are delivery facts for validation, not properties inherited from the older graph source or 3:1 study.
